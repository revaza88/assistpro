...
export default function HRServicePage() {
  ...
  const benefits = [
    t('services.hr.benefitTalent'),
    t('services.hr.benefitCompliance'),
    t('services.hr.benefitMotivation'),
    t('services.hr.benefitCulture'),
  ].filter(Boolean);

  const serviceList = (t('services.hr.serviceList', { returnObjects: true }) as string[] || []).filter(Boolean);
      ...
      <main className="flex-grow">
        ...
        >
          <div className="container mx-auto px-4 text-center">
            ...
            <UserGroupIcon className="w-16 h-16 sm:w-20 sm:h-20 text-brand-gold-400 mx-auto mb-6" />
          ...
          >
            {benefits.length > 0 && (
              <section className="mb-10 sm:mb-12 lg:mb-16">
                <SectionTitle title={t('services.hr.whyImportantTitle')} icon={ArrowTrendingUpIcon} />
            ...
            {serviceList.length > 0 && (
              <section className="mb-10 sm:mb-12 lg:mb-16">
                <SectionTitle title={t('services.hr.servicesIncludeTitle')} icon={DocumentTextIcon} />
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" asChild className="bg-brand-gold-500 hover:bg-brand-gold-600 text-brand-blue-700 font-semibold shadow hover:shadow-lg text-base">
                  <Link href="/contact">
                    {t('services.hr.ctaRequestConsultation')}
                  </Link>
                </Button>
